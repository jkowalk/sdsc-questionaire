const test_data = {
    "rolle_im_unternehmen": "abteilungsleitung",
    "arbeit_mit_daten": [
        "datenerhebung"
    ],
    "datenkenntnis": "3",
    "sicher_datenumgang": "4",
    "daten_erklären": "3",
    "arbeit_an_ml": "5",
    "ml_kenntnis": "4",
    "anwendungsfall_kenntnis": "4",
    "zusammenhang_daten_ziel": "3",
    "unternehmensname": "Test",
    "domain": "A",
    "sitz_in_bw": "true",
    "bilanzsumme": "bis_10",
    "unternehmen_wissen_ml": "3",
    "ansprechpartner": "3",
    "unternehmen_erfahrung_ml_projekte": "5",
    "unternehmen_unterstützung_potentialanalyse": "4",
    "Abteilungsbeschreibung": "asdf",
    "daten_erhebung_text": "asdf",
    "richtung_potentialanalyse": [
        "optimierung"
    ],
    "ziel_potentialanalyse_beschreibung": "asdf",
    "problem_lösung_aktuell": "keine_lösung",
    "ausreichend_daten_gesammelt": "3",
    "daten_vorverarbeitet": "4",
    "kostenfunktion": "5",
    "eingangs_ziel_variablen": "5",
    "dsgvo": "false",
    "rechte_an_daten": "true",
    "merkmale_enthalten": "3",
    "question2": "4",
    "zeitreihen_vollständig": "4",
    "zustände_vertreten": "4",
    "einflussfaktoren_enthalten": "4",
    "anzahl_spalten_zeilen": {
        "spalten": 132,
        "zeilen": 123
    },
    "stellgrößen_enthalten": "4",
    "wertebereich_stellgrößen_bekannt": "4",
    "standardprozess": "5",
    "dokumentation_existiert": "5",
    "datenformat_csv": "5",
    "datenerfassung_vollautomatisch": "4",
    "mehrere_datenquellen": "4",
    "messfehler_existieren": "4",
    "datenerhebung_objektiv": "4",
    "inkonsistenzen_existieren": "4",
    "aktualität": "4",
    "kontakt_vorname": "asdf<",
    "kontakt_nachname": "asdf",
    "kontakt_email_adresse": "usxav@student.kit.edu",
    "kontakt_telefonnummer": "asdf21",
    "unternehmensanschrift": "asdf",
    "accept_agb": [
        "true"
    ],
    "bearbeiter_daten_ml_kenntnis": 3.7142857142857144,
    "förderung_geeignet": true,
    "ist_kmu": true,
    "score_dateneffizienz": 3.8,
    "score_datenorganisation": 4.166666666666667,
    "score_fehlerfreiheit": 4,
    "score_aktualität": 4,
    "unternehmen_ml_kompetenz": 3.75,
    "zeitbereich_dauer": 0,
    "score_problemstellung": 4.5,
    "overall_score": 4.093333333333334
};

const test_surveyJson =
    {
        "locale": "de",
        ...
        "completedHtml": {
            "default": "Thanks",
            "de": "<p><br>Vielen Dank für Ihre Angaben und Ihr Interesse.<br><br>In Kürze erhalten Sie Ihren automatisch generierten Report, mit Ihrem Datenanalyse-Potential Ergebnis.<br>Unsere Experten melden sich so bald wie möglich bei Ihnen.</p>"
        },
        "pages": [
            {
                "name": "info-page",
            ...
            },
            {
                ...
                "visibleIf": "{ausreichend_daten_gesammelt} >= 3 and {rechte_an_daten} = true and ({dsgvo} = false or {anonymisierung} = true)",
                "title": {
                    "de": "Datenlage"
                }
            },
            ...
            },
            {
                ...
                "visibleIf": "{bearbeiter_daten_ml_kenntnis} >= 3 and {ausreichend_daten_gesammelt} >= 3 and {rechte_an_daten} = true and ({dsgvo} = false or {anonymisierung} = true)",
                "title": {
                    "de": "Datenqualität"
                }
            },
        ...
        "calculatedValues": [
            ...
            },
            {
                ...
                "expression": "avg({standardprozess}, {dokumentation_existiert}, {wertebereich_stellgrößen_bekannt}, {datenformat_csv}, {datenerfassung_vollautomatisch}, 6-{mehrere_datenquellen})",
                "includeIntoResult": true
            },
            {
...
exports.test_surveyJson = test_surveyJson;